...
import logoDark from '../../../../assets/tools/logo-dark-text.png'
        ...
        <SliderContainer>
          <main>
            <section>
              ...
              <span>
                <Image src={logoDark} alt='' width={120} height={110} objectFit='contain'/>
              </span>
              ...
              {/* repeated*/}
                ...
                <span>
                  <Image src={nextLogoDark} alt='' width={130} height={130} objectFit='contain'/>
                </span>
                <span>
                  <Image src={reactLogo} alt='' width={130} height={120} objectFit='contain'/>
                </span>
